                  ...
                  <div className="mt-5 space-y-4 border-t border-[#efe5da] pt-5">
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="rounded-[1.4rem] border border-[#e7ddd1] bg-[#f8f4ee] p-4">
                        ...
                        <p className="mt-2 text-sm font-semibold text-[#5a493d]">
                          {report.commentAuthorNickname ?? "닉네임 없음"}
                        </p>
                        <p className="mt-1 break-all text-sm text-[#7b6c60]">
                          {report.commentAuthorEmail ?? "이메일 없음"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-[1.6rem] border border-[#e7ddd1] bg-[#f8f4ee] p-5">
                      ...
                      <p className="mt-3 text-sm font-semibold text-[#6f6054]">
                        @{report.commentAuthorName ?? "알 수 없음"}
                      </p>
                      <p className="mt-3 whitespace-pre-wrap text-sm leading-7 text-[#5a493d]">
                        {report.commentContent ?? "삭제된 댓글이에요."}
                      </p>
                      {report.postId ? (
                        <Link
                          href={`/community/${report.postId}#comment-${report.commentId}`}
